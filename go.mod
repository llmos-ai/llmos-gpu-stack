...
replace github.com/rancher/wrangler/v3 => github.com/oneblock-ai/wrangler/v3 v3.0.0-20250520152531-c60658a7289e

require (
	github.com/cloudwego/hertz v0.10.0
	github.com/google/go-containerregistry v0.20.4
	github.com/llmos-ai/cli v0.0.0-20250415073018-ed1b2f758fb0
